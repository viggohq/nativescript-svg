...
declare class Node extends NSObject {
	...
	appendXMLToStringAvailableNamespacesActiveNamespaces(outputString: NSMutableString, prefixesByKNOWNNamespace: NSDictionary<any, any>, prefixesByACTIVENamespace: NSMutableDictionary<any, any>): void;
...
declare function SVGColorFromString(string: string): SVGColor;
...
declare class SVGKExporterNSData extends NSObject {
	...
	static exportAsNSDataAntiAliasedCurveFlatnessFactorInterpolationQualityFlipYaxis(image: SVGKImage, shouldAntialias: boolean, multiplyFlatness: number, interpolationQuality: CGInterpolationQuality, flipYaxis: boolean): NSData;
...
declare class SVGKExporterUIImage extends NSObject {
	...
	static exportAsUIImageAntiAliasedCurveFlatnessFactorInterpolationQuality(image: SVGKImage, shouldAntialias: boolean, multiplyFlatness: number, interpolationQuality: CGInterpolationQuality): UIImage;
...
declare class SVGKImage extends NSObject {
	...
	renderToContextAntiAliasedCurveFlatnessFactorInterpolationQualityFlipYaxis(context: any, shouldAntialias: boolean, multiplyFlatness: number, interpolationQuality: CGInterpolationQuality, flipYaxis: boolean): void;
...
declare class SVGKParserDOM extends NSObject implements SVGKParserExtension {
	...
	handleStartElementDocumentNamePrefixNamespaceURIAttributesParseResultParentNode(name: string, document: SVGKSource, prefix: string, XMLNSURI: string, attributes: NSMutableDictionary<any, any>, parseResult: SVGKParseResult, parentNode: Node): Node;
...
declare function SVGPercentageFromString(string: string): number;
...
declare function createPathFromPointsInString(string: string, close: number): interop.Unmanaged<any>;
